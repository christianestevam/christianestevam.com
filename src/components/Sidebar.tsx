...
const socialMedia = [
  {
    ...
    url: 'https://twitter.com/christianestev_'
  },
  {
    name: 'LinkedIn',
    icon: <CiLinkedin size="28px" />,
    url: 'https://www.linkedin.com/in/christian-estevam-barbosa/'
  },
  {
    name: 'GitHub',
    icon: <AiOutlineGithub size="24px" className="ml-0.5" />,
    url: 'https://github.com/christianestevam'
  }
]
